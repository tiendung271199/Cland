...
<div class="clearfix main_content floatleft">
	<div class="clearfix content">
		...
		<div class="clearfix single_work_container">
			<c:choose>
				<c:when test="${not empty searchLandList}">
					<c:forEach items="${searchLandList}" var="objLand" >
					...
					<div class="clearfix work_pagination">
						<nav>
							...
							<a class="newer floatleft" href="${urlSearch}/${searchContent}/${pagePrevious}"> &lt; -- Trang trước</a>
							<a class="older floatright" href="${urlSearch}/${searchContent}/${pageNext}">Trang kế -- &gt;</a>
						</nav>
					</div>
				</c:when>
				<c:otherwise>
