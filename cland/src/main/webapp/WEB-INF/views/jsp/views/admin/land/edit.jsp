...
<div class="row">
	<div class="col-md-12 panel-info">
		...
		<div class="content-box-large box-with-header">
			<form action="${urlLand}/edit" method="post" enctype="multipart/form-data" >
				<div>
					<div class="row mb-10"></div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="lid">ID tin</label>
								<input type="text" name="lid" value="${objLand.lid}" class="form-control" readonly>
							</div>
